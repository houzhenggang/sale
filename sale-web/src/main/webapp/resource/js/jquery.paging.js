/**
 * Created by useer on 2016/12/14.
 */
    ...
    $.fn.extend({
        paging: function (options) {
            ...
            return this.each(function () {
                ...
                //初始化两侧按钮
                $this.append('<div class="otherBtns"><a value="首页" class="first">' + opts.firstBtnString + '</a><a value="上一页">' + opts.beforeBtnString + '</a></div><div class="centerBtns"><ul></ul></div><div class="otherBtns"><a value="下一页">' + opts.nextBtnString + '</a><a value="尾页">' + opts.lastBtnString + '</a></div><div class="jumpBtns"><input type="text" class="jump_input" data="" /><a class="jump_a" data="0">' + opts.jumpBtnString + '</a></div>');
