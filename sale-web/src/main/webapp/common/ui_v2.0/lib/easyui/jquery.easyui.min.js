...
var _286="<div class=\"messager-content\">"+msg+"</div>";
switch(icon){
case "error":
...
var _289="<div class=\"messager-icon messager-question\"></div>"+"<div class=\"messager-content\">"+msg+"</div>"+"<div style=\"clear:both;\"/>";
var _28a={};
...
var _28c="<div class=\"messager-icon messager-question\"></div>"+"<div class=\"messager-content\">"+msg+"</div>"+"<br/>"+"<div style=\"clear:both;\"/>"+"<div><input class=\"messager-input\" type=\"text\"/></div>";
var _28d={};
...
//_51e.children(".datagrid-view2 .datagrid-body").width(_51e.width()+20);
//_51e.children(".datagrid-view2 .datagrid-header").width(_51e.width()+20);
var datagridBody = $(".datagrid-view2 .datagrid-body");
	$(".datagrid-view2 .datagrid-body").each(function(){
		$(this).scrollTop(10);//控制滚动条下移10px
		var scrollHeight = $(this)[0].scrollHeight;
		var clientHeight = $(this)[0].clientHeight;
		if(scrollHeight>clientHeight){  
			$(this).children("table").css("width",$(this).parent().children(".datagrid-header").children(".datagrid-header-inner").children("table").css("width"));
		}
	});
 
//$(".datagrid-body").scrollTop(0);//滚动条返回顶部  
var hh;
_51f.css("height","");
_520.css("height","");
_521.css("height","");
