...
var c=String.fromCharCode(e.asich);
...
if((e.asich>=48&&e.asich<=57&&e.ctrlKey==false&&e.shiftKey==false)||e.asich==0||e.asich==8){
return true;
}else{
if(e.ctrlKey==true&&(e.asich==99||e.asich==118)){
return true;
}else{
return false;
}
